...
//============================================================================//
// a. 最初に個数を指定してその数だけ入力する代わりに、
// 順番に数値を入力して最後に 0 を入れると終わり、
// 入力した個数 (0 は含まない) を返す関数 int riarrayz(int lim, int a[])。
// lim は最大個数で、それより多く入力してはいけない。動かすと次のようになる。
// 10
// 1> 21
// 2> 31
