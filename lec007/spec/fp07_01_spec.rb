...
describe "演習1" do
  context "arraminrange" do
    ...
    it "arraminrange([5,10,2,0,8,9,-9,0,2],0,4)" do
      results = arraminrange([5,10,2,0,8,9,-9,0,2],0,4)
      expect(results).to eq 3
    end
    it "arraminrange([5,10,2,0,8,9,-9,0,2],0,8)" do
  ...
  context "selectionsort" do
    ...
    it "selectionsort([1000,100,10,10000,1])" do
      ...
      expect(results).to eq [1,10,100,1000,10000]
    end
    it "selectionsort([11,1,-1,111,-1])" do
      results = selectionsort([11,1,-1,111,-1])
      expect(results).to eq [-1,-1,1,11,111]
    end
    it "" do
